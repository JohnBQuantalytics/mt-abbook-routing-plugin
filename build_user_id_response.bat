...
del test_user_id_response.exe 2>nul
cl.exe /EHsc /MT test_user_id_response.cpp ws2_32.lib /Fe:test_user_id_response.exe
...
echo SUCCESS: Built test_user_id_response.exe
pause 